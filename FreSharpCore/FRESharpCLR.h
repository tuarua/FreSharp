...
namespace FRESharpCore {
	...
	public:
		...
		void setProperty(FREObjectCLR freObject, String^ name, FREObjectCLR value, UInt32% freresult);
		void setProperty(FREObjectCLR freObject, String^ name, String^ value, UInt32% freresult);
		void setProperty(FREObjectCLR freObject, String^ name, double value, UInt32% freresult);
		void setProperty(FREObjectCLR freObject, String^ name, bool value, UInt32% freresult);
		void setProperty(FREObjectCLR freObject, String^ name, Int32 value, UInt32% freresult);
		void setProperty(FREObjectCLR freObject, String^ name, UInt32 value, UInt32% freresult);
